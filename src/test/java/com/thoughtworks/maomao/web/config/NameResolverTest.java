...
import com.thoughtworks.maomao.web.controller.BookController;
...
public class NameResolverTest {
    ...
    public void should_get_index_view() {
        assertEquals("/com/thoughtworks/maomao/web/view/book/index.stg", nameResolver.getIndexView());
    }

    @Test
    public void should_get_show_view() {
        assertEquals("/com/thoughtworks/maomao/web/view/book/show.stg", nameResolver.getShowView());
    }
}
